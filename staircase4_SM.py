...
def upsert_result_csv(result, filename="Output/staircase4_SM.csv"):
...
def write_fancy_table_to_csv(ins, n, m, c, val, s_cons, h_cons, peak, status, time_elapsed, filename="staircase4_SM.csv"):
    global best_result
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1 and sys.argv[1] in ['-h', '--help', 'help']:
        print("Usage:")
        print("  python3 staircase4_SM.py              # Run all instances with runlim")
        print("  python3 staircase4_SM.py <id>         # Run single instance by ID")
        print("  python3 staircase4_SM.py easy         # Run only easy instances (0-38)")
        print("  python3 staircase4_SM.py hard         # Run only hard instances (39+)")
        print("  python3 staircase4_SM.py all          # Run all instances")
        print("")
        ...
        print("")
        print("Files created:")
        print("  Output/staircase4_SM.csv   # CSV results")
        print("  Output/staircase4_SM.xlsx  # Excel results")
    ...
    if len(sys.argv) == 1:
        ...
        excel_file = 'Output/staircase4_SM.xlsx'
        csv_file = 'Output/staircase4_SM.csv'
        ...
        for instance_id in range(0, len(file_name1)):
            ...
            command = f"./runlim -r {TIMEOUT} {sys.executable} staircase4_SM.py {instance_id}"
