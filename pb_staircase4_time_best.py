    ...
    while True:
        ...
        for t in range(c):
            ...
            for clause in pb_enc.clauses:
                solver.add_clause(clause)
                # print(stations)
def write_fancy_table_to_csv(ins, n, m, c, val, s_cons, h_cons, peak, status, time_elapsed, filename="pb_all_time_best.csv"):
    global best_result
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1 and sys.argv[1] in ['-h', '--help', 'help']:
        ...
        print("")
        print("Files created:")
        print("  Output/pb_all_time_best.csv   # CSV results")
    ...
    if len(sys.argv) == 1:
        ...
        csv_file = 'Output/pb_all_time_best.csv'
        ...
        for instance_id in range(0, len(file_name1)):
            ...
            command = f"./runlim -r {TIMEOUT} python3   pb_staircase4_time_best.py {instance_id}"
