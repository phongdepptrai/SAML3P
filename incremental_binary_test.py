...
def write_fancy_table_to_csv(ins, n, m, c, val, s_cons, h_cons, peak, status, time_elapsed, filename="incremental_test.csv"):
    global best_result
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1 and sys.argv[1] in ['-h', '--help', 'help']:
        ...
        print("")
        print("Files created:")
        print("  Output/Incremental_test.csv   # CSV results")
    ...
    if len(sys.argv) == 1:
        ...
        csv_file = 'Output/incremental_test.csv'
        ...
        # Here
        for instance_id in range(89, len(file_name1)):
            ...
            command = f"./runlim -r {TIMEOUT} python3 incremental_binary_test.py {instance_id}"
