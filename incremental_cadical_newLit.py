...
def write_fancy_table_to_csv(ins, n, m, c, val, s_cons, h_cons, peak, status, time_elapsed, filename="newlit.csv"):
    global best_result
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1:
        ...
        for instance_id in range(25, len(file_name1)):
            ...
            command = f"wsl ./runlim -r {TIMEOUT} /mnt/c/Users/admin/Documents/Python/SAML3P/.venv/Scripts/python.exe incremental_cadical_newLit.py {instance_id}"
