...
def write_fancy_table_to_csv(ins, n, m, c, var_count, cons_count, peak, sol_count, solbb_count, status, time_taken, filename="staircase4_cadical.csv"):
...
def main():
    ...
    if not os.path.exists("Output/staircase4_cadical.csv"):
        with open("Output/staircase4_cadical.csv", "w", newline='') as f:
            writer = csv.writer(f)
